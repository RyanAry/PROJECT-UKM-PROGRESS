                ...
                <nav class="bg-primary" x-data="{ isOpen: false }">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="hidden md:block">
                                    <div class="ml-10 flex items-baseline space-x-4">
                                        ...
                                        <a href="#" class="px-3 py-2 text-sm font-medium text-white">Hotel</a>
                                        <a href="#" class="px-3 py-2 text-sm font-medium text-white">Things To Do</a>
                                    </div>
                                </div>
                            </div>
                            <div class="hidden md:block">
                    ...
                    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
                        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                            ...
                            <a href="#" class="block px-3 py-2 text-base font-medium text-white">Things To Do</a>
                        </div>
